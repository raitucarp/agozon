...
// the map of localeUS
var LocaleUSMap = map[string]LocaleSearchIndex{
	"All":                LocaleUS.All,
	"Apparel":            LocaleUS.Apparel,
	"Appliances":         LocaleUS.Appliances,
	"ArtsAndCrafts":      LocaleUS.ArtsAndCrafts,
	"Automotive":         LocaleUS.Automotive,
	"Baby":               LocaleUS.Baby,
	"Beauty":             LocaleUS.Beauty,
	"Blended":            LocaleUS.Blended,
	"Books":              LocaleUS.Books,
	"Classical":          LocaleUS.Classical,
	"Collectibles":       LocaleUS.Collectibles,
	"DVD":                LocaleUS.DVD,
	"DigitalMusic":       LocaleUS.DigitalMusic,
	"Electronics":        LocaleUS.Electronics,
	"Fashion":            LocaleUS.Fashion,
	"FashionBaby":        LocaleUS.FashionBaby,
	"FashionBoys":        LocaleUS.FashionBoys,
	"FashionGirls":       LocaleUS.FashionGirls,
	"FashionMen":         LocaleUS.FashionMen,
	"FashionWomen":       LocaleUS.FashionWomen,
	"GiftCards":          LocaleUS.GiftCards,
	"GourmetFood":        LocaleUS.GourmetFood,
	"Grocery":            LocaleUS.Grocery,
	"HealthPersonalCare": LocaleUS.HealthPersonalCare,
	"HomeGarden":         LocaleUS.HomeGarden,
	"Industrial":         LocaleUS.Industrial,
	"Jewelry":            LocaleUS.Jewelry,
	"KindleStore":        LocaleUS.KindleStore,
	"Kitchen":            LocaleUS.Kitchen,
	"LawnAndGarden":      LocaleUS.LawnAndGarden,
	"Luggage":            LocaleUS.Luggage,
	"MP3Downloads":       LocaleUS.MP3Downloads,
	"Magazines":          LocaleUS.Magazines,
	"Miscellaneous":      LocaleUS.Miscellaneous,
	"MobileApps":         LocaleUS.MobileApps,
	"Music":              LocaleUS.Music,
	"MusicTracks":        LocaleUS.MusicTracks,
	"MusicalInstruments": LocaleUS.MusicalInstruments,
	"OfficeProducts":     LocaleUS.OfficeProducts,
	"OutdoorLiving":      LocaleUS.OutdoorLiving,
	"PCHardware":         LocaleUS.PCHardware,
	"PetSupplies":        LocaleUS.PetSupplies,
	"Photo":              LocaleUS.Photo,
	"Shoes":              LocaleUS.Shoes,
	"Software":           LocaleUS.Software,
	"SportingGoods":      LocaleUS.SportingGoods,
	"Tools":              LocaleUS.Tools,
	"Toys":               LocaleUS.Toys,
	"UnboxVideo":         LocaleUS.UnboxVideo,
	"VHS":                LocaleUS.VHS,
	"Video":              LocaleUS.Video,
	"VideoGames":         LocaleUS.VideoGames,
	"Watches":            LocaleUS.Watches,
	"Wireless":           LocaleUS.Wireless,
}
